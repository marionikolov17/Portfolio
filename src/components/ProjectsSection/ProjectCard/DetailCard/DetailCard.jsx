...
export default function DetailCard({ project }) {
    ...
    return (
        <>
            <section className="w-full h-screen fixed project-background top-0 p-24">
                <div className="w-full min-h-[700px] bg-white rounded-lg flex">
                    {/* Project images section */}
                    <div className="overflow-hidden grow-0 w-[40%] flex items-center justify-center border-r relative">
                        <img src={project.images[currentImageIndex]} alt="" className="object-cover" />

                        <div className="w-full flex absolute bottom-0 py-2 justify-center items-center">
